            ...
            <form className="mt-12">
                      ...
                      <div className="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                        <div>
                          ...
                          <div className="mt-4 flex items-center sm:absolute sm:top-0 sm:left-1/2 sm:mt-0 sm:block">
                            ...
                            >
                              <span onClick={() => removeAllWithId(product._id)}>Remove</span>
                            </button>
                          </div>
                        </div>
              ...
              <section aria-labelledby="summary-heading" className="mt-10 sm:ml-32 sm:pl-6">
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                  <p>
                    or &nbsp;
                    <span onClick={handleContinueShopping} className="cursor-pointer font-medium text-indigo-600 hover:text-indigo-500">
                      Continue Shopping
