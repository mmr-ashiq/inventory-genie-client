      ...
      <>
        {typeof product !== 'undefined' && (
          <div className="p-4">
            ...
            <img src={randomImage} className="w-64 h-auto mb-8 rounded-sm" alt="Product" />
            <p className="mb-4">
              <span className="font-bold">Product Name:</span> {product?.name}
            </p>
            <p className="mb-4">
              <span className="font-bold">Product Description:</span> {product?.description}
            </p>
            <p className="mb-4">
              <span className="font-bold">Category:</span> <Category data={product?.category} />
            </p>
            <p className="mb-4">
              <span className="font-bold">Price:</span> {product?.price}
            </p>
            <p className="mb-4">
              <span className="font-bold">Variants:</span> <Category data={product?.variants} />
            </p>
            <p className="mb-4">
