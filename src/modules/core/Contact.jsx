					...
					<div className="grid grid-cols-1 lg:grid-cols-3">
						...
						<div className="relative px-6 py-10 overflow-hidden bg-indigo-700 sm:px-10 xl:p-12">
							...
							<p className="max-w-3xl mt-6 text-base text-indigo-50">
								...
								We'll get back to you as soon as possible. You can also find our
								phone number and email address on this page if you prefer to
								contact us directly. We're always happy to help you with any
								issues you may encounter while using our inventory management
								system.
							</p>
